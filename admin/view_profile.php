...
<body>
    ...
    <div class="main">
        <div class="title2">
            <a href="admin.php">Home</a><span>/ Profile Information</span>
        </div>
            ...
            <div class="profile-info">
                <div class="profile-picture">
                    ...
                    <div class="form-container">
                        <form method="post" enctype="multipart/form-data" action="../includes/update_profile_admin.php">
                ...
                <div class="profile-details">
                    ...
                    <form method="post" action="../includes/update_profile_admin.php" id="profileForm">
